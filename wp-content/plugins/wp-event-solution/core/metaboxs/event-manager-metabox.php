            ...
            <div class="etn-meta">                
                ...
                <div class="etn-recurring-event-span etn-recurring-single-item" id="etn-recurring-event-span">
                    ...
                    <div class='floatleft event-span-days'>
                        <input type="checkbox" name="span_type" value="single" id="single"/>
                        <label for="single"><?php esc_html_e('Single day', 'eventin');?></label><br>
                        <input type="checkbox" name="span_type" value="multiple" id="multiple"/>
                        <label for="multiple"><?php esc_html_e('Multiple day', 'eventin');?></label><br>
                    </div>
                    <div class='floatleft event-span-days'>
                        <input class="etn-form-control" type="number" name="<?php echo esc_attr( $key . "[recurrence_span]" ) ;?>" value="<?php echo esc_attr( $event_span_days ); ?>" min='1'/>
                        <span><?php echo esc_html__('days', 'eventin');?></span>
