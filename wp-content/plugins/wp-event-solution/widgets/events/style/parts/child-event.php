...
if ( !empty( $show_child_event ) && true == $show_child_event ) {
                                ...
                                <div class="etn-atend-btn">
                                    <?php
                                        ...
                                        if ($show_form_button === false) {
                                            ...
                                            ?>
                                            <a href="<?php echo esc_url(get_the_permalink($item->ID)); ?>" class="etn-btn etn-btn-border" title="<?php echo get_the_title($item->ID); ?>"><?php echo esc_html__('Attend', 'eventin') ?> <i class="fas fa-arrow-right"></i></a>
                                            <?php
                                        }
                                    ?>
                                </div>
