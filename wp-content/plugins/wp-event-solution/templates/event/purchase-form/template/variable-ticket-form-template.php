...
<form method="post" class="etn-event-form-parent etn-ticket-variation"  data-etn_uid="<?php echo esc_html($unique_id); ?>" data-decimal-number-points="<?php echo class_exists( 'WooCommerce' ) ? esc_attr( wc_get_price_decimals() ) : '2'; ?>">
                    ...
                    <div class="etn-single-ticket-item">
                        ...
                        <div class="etn-ticket-price-body <?php echo esc_attr($stock_outClass) ?>">
                            <div class="ticket-price-item etn-ticket-price">
                                ...
                                <strong>
                                    <?php
                                        ...
                                        }  echo intval($value['etn_ticket_price']);
                                    ?>
                                </strong>
                            </div>
                            ...
                            <div class="ticket-price-item etn-quantity">
                                ...
                                <input name="ticket_quantity[]" type="number" class="etn_ticket_variation ticket_<?php echo intval($key); ?>" value="0"
    ...
    if (!isset($event_options["etn_purchase_login_required"]) || (isset($event_options["etn_purchase_login_required"]) && is_user_logged_in())) {
        ...
        ?>
        <input name="submit" class="etn-btn etn-primary etn-add-to-cart-block disabled <?php echo esc_attr( absint( $single_event_id ) ); ?>" 
            data-event_id="<?php echo esc_attr( absint( $single_event_id ) ); ?>" data-validation_checked="0"
            data-multivendor_active="<?php echo $multivendor_active ? '1' : '0'; ?>" 
            type="submit" value="<?php $cart_button_text = apply_filters( 'etn_event_cart_button_text', esc_html__("Buy ticket", "eventin") ); echo esc_html( $cart_button_text ); ?>" />
        <?php
    } else {
        ?>
        <small>
